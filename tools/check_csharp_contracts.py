...
def check_model_property_references() -> None:
    ...
    for required_prop in ["GeneratedBuff", "AltGeneratedBuff", "HoldGeneratedBuff", "MobilityMode", "AltMobilityMode", "HoldLightStrength", "RejectedEngineCalls", "ConsumeChancePercent", "ChannelUse", "HeldVisibility", "ReleaseTiming", "HandPose", "InitialOffsetPx"]:
