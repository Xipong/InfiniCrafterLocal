...
def sound_catalog_card_for_llm() -> dict[str, Any]:
    ...
    return {
        ...
        "selectionRule": "Choose exact ids only; no names/prose/taxonomy inference. Omitting an id explicitly means silence for that event; no fallback will be composed.",
