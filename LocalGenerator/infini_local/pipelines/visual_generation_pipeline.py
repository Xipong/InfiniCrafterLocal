    ...
    try:
        ...
        payload = {
            ...
            "rules": [
                ...
                "vfxScaleHint and vfxRhythmHint are each exactly one allowed enum string, and vfxAvoid is exactly one string; these three fields are never arrays. vfxMaterialHints is the only VFX hint field that is an array.",
                anime_rule,
            ],
