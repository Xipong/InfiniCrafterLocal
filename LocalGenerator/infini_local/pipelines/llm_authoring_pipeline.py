...
def repair_author_item_after_failure(
    ...
    *,
    ...
    repair_system = (
        ...
        "For every bindingId in repairScope.bindingAlternatives that you update, copy one complete input/action/target tuple verbatim into bindingsUpsert; never cross-product fields from different alternatives. When a repairRequirement sets mustChooseExactlyOne without mustCreateExactlyOne, update exactly one existing binding matching its allowedBindingTransactions, not all candidate bindings. "
