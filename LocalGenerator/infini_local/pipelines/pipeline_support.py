...
# =============================================================================
# Explicit cross-pipeline dependencies used by legacy-compatible support helpers
# =============================================================================
# These imports are intentionally placed after all helper definitions.  The
# pipeline modules import this support module at their own tail, so late imports
# avoid circular import failures while still keeping dependencies explicit.
