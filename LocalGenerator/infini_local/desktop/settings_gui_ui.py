...
class SettingsGuiUiMixin:
    ...
    def _build_general(self, parent):
        ...
        self.row(radmin_card, "Asset transport", "INFINI_MP_ASSET_TRANSPORT", values=["native", "http"], hint="native = PNG через Terraria packets; http = PNG через host /get_asset.")
        self.row(radmin_card, "Public asset URL", "INFINI_ASSET_PUBLIC_BASE_URL", hint="Нужен только для HTTP: http://26.x.x.x:5055.")
