...
PRESET_HELP = {
    "OpenAI-compatible + FLUX.2 Klein 4B hybrid": "Контракт пишет выбранный OpenAI-compatible API (например Gemini), PNG рисует FLUX.2 Klein 4B: ROCm TE+diffusion, Vulkan VAE, TE weights в CPU RAM; 512x512/4 steps/CFG 1/Euler. prompt_light не отправляет несовместимое API reasoning-поле.",
