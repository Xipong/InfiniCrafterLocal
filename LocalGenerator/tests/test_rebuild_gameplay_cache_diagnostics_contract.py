...
def test_runtime_sprite_cache_exposes_debug_snapshot_and_manual_controls():
...
def test_generated_swing_onhit_executes_bounded_authored_codes():
...
def test_rebuild_qol_config_localization_and_contract_stamp():
